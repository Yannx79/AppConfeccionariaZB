...
public static final String SQL_CREATE = "INSERT INTO `proveedor`(`nombres `, "
            + "`ap_paterno `, `ap_materno`, `ruc`, `dni`, `telefono`, "
            + "`f_insercion`, `f_actualizacion`, `f_eliminacion`, `estado`) VALUES "
            + "(?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
